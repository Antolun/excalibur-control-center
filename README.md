<b>!!!NOTE:</b> If you have an EXCALIBUR branded computer, LupuS will automatically install this driver!
...
```bash
# LupuS
sudo pisi it base-devel linux-ferus-headers
```
...
- **Power Plan Management:** Detailed descriptions of each power plan:
  - `High` — Maximum performance, maximum fan speed
  - `Gaming` — Balanced performance and thermals
  - `Normal` — Reduced performance, quiet operation
  - `Low` — Maximum battery life, minimal fan activity
